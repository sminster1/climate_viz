...
# Using Ggplot2 to Recreate a Line Plot of Annual Temperature Anomalies (CC217), 2022, 
...
t_data %>% 
  ...
  geom_text(data = annotation, 
            ...
            inherit.aes = FALSE,
            hjust = 0, size = 4, nudge_x = 0.15, fontface = "bold") +
  ...
  scale_color_viridis_c(breaks = seq(1880, 2020, 20),
                        guide = guide_colorbar(frame.colour = "white", # note colour is with a "u"
                                               frame.linewidth = 0.5)) + 
